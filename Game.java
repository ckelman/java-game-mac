...
public class Game extends Applet implements ActionListener, KeyListener//, Runnable
{
    ...
    private ArrayList<Platform> platforms12;
    ...
    private ArrayList<Person> enemies12;

    private Timer t;

    private AudioClip machineGun;
    private AudioClip shotGun;
    private AudioClip flameGun;
    private AudioClip sniperGun;
    private AudioClip freezeGun;
    private AudioClip background;
    private AudioClip explosionSound;
    private AudioClip boxSound;
    private AudioClip characterHitSound;
    private AudioClip turretSound;
    private AudioClip deathSound;
    private AudioClip crouch;

    private AudioClip jump;

    private boolean crouched,isFun,isMachineGunLooping,isFlameGunLooping,isFreezeGunLooping,isTurretSoundLooping,isDead,isBackgroundLooping;
    ...
    public void init()
    {
        ...
        gameState = 0;
        machineGun = getAudioClip(getCodeBase(),"Machine_Gun3.wav");
        shotGun = getAudioClip(getCodeBase(),"357mag.wav");
        sniperGun = getAudioClip(getCodeBase(),"RIFLE2.WAV");
        flameGun = getAudioClip(getCodeBase(),"RealFire.wav");
        background = getAudioClip(getCodeBase(),"smb-overworld.wav");
        freezeGun = getAudioClip(getCodeBase(),"wind1.wav");
        explosionSound = getAudioClip(getCodeBase(),"Explosion.wav");
        boxSound = getAudioClip(getCodeBase(),"Box.wav");
        characterHitSound = getAudioClip(getCodeBase(),"characterHit.wav");
        turretSound = getAudioClip(getCodeBase(),"turretSound.wav");
        deathSound = getAudioClip(getCodeBase(),"DeathSound.wav");

        jump = getAudioClip(getCodeBase(),"jump.wav");

        isMachineGunLooping=false;
        isFlameGunLooping = false;
        isFreezeGunLooping = false;
        isTurretSoundLooping = false;
        isDead = false;
        isBackgroundLooping = false;

        turrets = new ArrayList[12];
        ...
        t4.add(new Turret(75,430,50,50));
        ...
        enemies12 = new ArrayList<Person>();

        enemyLevel = new ArrayList[12];
        ...
        platforms5.add(new Platform(0, 370, 50, 5));
        platforms5.add(new Platform(150, 320, 65, 5));
       ...
       // platforms6.add(new Platform(900, 425, 15, 10));
        ...
        platforms7.add(new Platform(780,470,290,10));
        ...
        platforms11.add (new MovingPlatform(150,300,50,10,2,0,(int)(65*(3/2.0))));
        platforms11.add (new MovingPlatform(400,180,50,10,0,-2,60));
        platforms11.add (new MovingPlatform(50,200,50,10,2,0,120));
        platforms11.add (new MovingPlatform(0,200,50,10,0,2,70));
        platforms11.add (new MovingPlatform(80,60,50,10,2,0,(int)(125*(3/2.0))));
        ...
        platforms11.add (new MovingPlatform(800,350,50,10,0,2,(int)(80*(3/2.0))));
        ...
        platforms12 = new ArrayList<Platform>();
        platforms12.add(new Platform(0,480,1100,200));
        platforms12.add(new Platform(100,400,50,10));
        platforms12.add(new Platform(0,370,50,10));
        platforms12.add(new Platform(80,280,200,10));
        platforms12.add(new Platform(260,230,20,50));
        platforms12.add(new Platform(300,130,180,20));
        platforms12.add(new Platform(540,130,130,20));
        platforms12.add(new Platform(700,280,130,10));
        platforms12.add(new Platform(700,230,20,50));
        platforms12.add (new MovingPlatform(830,480,50,10,0,3,70));
        platforms12.add (new MovingPlatform(230,380,50,15,2,0,50));
        platforms12.add (new MovingPlatform(530,380,50,15,-2,0,50));
        platforms12.add (new MovingPlatform(530,380,50,15,2,0,50));
        platforms12.add(new MysteryPlatform(100,150,30,30));
        platforms12.add (new Platform(880,0,10,1000));


        platforms12.add(new Platform(-20,-100,20,800));
        platforms12.add(new Platform(1000,0,20,700));

        enemies12.add(new Boss(450,200));
        enemies12.get(0).setGun(new BossGun(0,0,0,0,new BossBullet(480,200)));
    ...
    public void paint (Graphics g)
    {
        ...
        if(gameState ==0)
        {
            ...
            g2.drawString("Press the F key for awesome sounds",120,250);
            g2.drawString("Press the N key for normal sounds",720,250);
            g2.drawString("Click the screen first",450,110);
            ...
            g2.setColor(Color.white);
            g2.fillOval(450,230,30,60);
            g2.fillOval(520,230,30,60);
            g2.fillOval(430,300,140,90);
            g2.setColor(Color.black);
            g2.fillOval(455,240,20,40);
            g2.fillOval(525,240,20,40);


            g2.setColor(Color.yellow);
            g2.fillRect(430,300,140,45);
        ...
        if(gameState==1)
        {
            ...
            if(lives>0&&currentLevel<levels.length)
            {
                ...
                if(currentLevel==0)
                {
                    ...
                    g2.drawString("Hold Up to fly*",300,140);
                    g2.drawString("Hold Space to shoot!",300,160);
                    g2.drawString("Use W,A,S,D + SPACE to controll the direction you shoot (ex. W+D to shoot up to the right or A+S to shoot down to the left)",300,180);
                    g2.drawString("Press Down to Crouch!!!!",300,200);
                    g2.drawString("GET TO THE FLAG TO WIN AN AMAZING PRIZE!!!",300,220);
            ...
            {
                g2.setColor(Color.black);
                g2.drawString("YOU LOSE",430,230);
                g2.drawString("Press Space to play again",400,250);
            ...
            else if(currentLevel>=levels.length)
            {
                ...
                g2.drawString("Press space to play again",325,260);
    ...
    public void actionPerformed (ActionEvent e)
    {
        ...
        turretSound.stop();
            ...
            else if(!isDead)
            {
                ...
                if(enemyLevel[11].size()==0 && levels[11].size()==17)
                    levels[11].remove(14);

                if(t.getDelay()==15&&!isBackgroundLooping)
                {
                    //background.loop();
                    isBackgroundLooping=false;
                }
                ...
                if(lives>0&&currentLevel<levels.length)
                {
                    ...
                    else if(hero.getGun().getType()==2)
                    {
                        gunString = "Shotgun";
                    }

                    else if(hero.getGun().getType()==3)
                    {
                        gunString = "Sniper";
                    }

                    else if(hero.getGun().getType()==4)
                    {
                        gunString = "FlameThrower";
                    }
                    else if(hero.getGun().getType()==5)
                    {
                        gunString = "Freeze Ray";
                    }
                    else if(hero.getGun().getType()==6)
                    {
                        gunString = "Turret";
                    }
                    ...
                    //             }
                    if(!hero.isPlatformBelow(levels[currentLevel]))
                        hero.setForce(hero.getForce()+.2);

                    for (int z = 0;z<= Math.abs((int)hero.getForce());z+=3)
                    {
                        if(hero.getForce()>0 && !hero.isPlatformBelow(levels[currentLevel]))
                            hero.setY(hero.getY()+3);
                        else if(hero.getForce()<0 &&!hero.isPlatformAbove(levels[currentLevel]))
                    ...
                    if((hero.isPlatformBelow(levels[currentLevel])&&!hero.getIsJumping())||hero.isPlatformAbove(levels[currentLevel]))
                        hero.setForce(0);
                    ...
                    if(hero.getIsFacingRight())
                    {
                        ...
                        if (hero.getY()!=lastY&&hero.getIsJumping())
                            hero.setState(2);
                    }
                    ...
                    for(Platform p : levels[currentLevel])
                    {
                        for(int i = 0; i<myBullets.size(); i++)
                        {
                            ...
                            if(b.intersects(p)||b.getDistanceCount()>=b.getDistance())
                            {
                                myBullets.remove(i);
                                i--;
                            }
                    ...
                    //                     if (hero.getGun().getIsShooting()&&hero.getGun().getShootTimer()==0&&hero.getGun().getAmmo()>0)
                    //         {
                    //             if(hero.getGun().getType()==1)
                    //             machineGun.loop();
                    //
                    ...
                    if(hero.getGun().getIsShooting()&& hero.getGun().getAmmo()>0 && hero.getGun().getShootTimer()==0)
                    {
                        ...
                        if(hero.getGun().getType()==1&&!isMachineGunLooping)
                        {
                            machineGun.loop();
                            isMachineGunLooping=true;
                        }
                        ...
                        else if(hero.getGun().getType()==4&&!isFlameGunLooping)
                        {

                            flameGun.loop();
                            isFlameGunLooping = true;

                        }
                        else if(hero.getGun().getType()==5&&!isFreezeGunLooping)
                        {
                            freezeGun.loop();
                            isFreezeGunLooping=true;
                        }
                        else if(hero.getGun().getType()==6&&!isTurretSoundLooping)
                        {
                            turretSound.loop();
                            isTurretSoundLooping=true;
                        }
                    ...
                    for(Person p: enemyLevel[currentLevel])
                    {
                        if(!p.isPlatformBelow(levels[currentLevel])&& !(p instanceof Boss))
                    ...
                    if(!hero.isPlatformBelow(levels[currentLevel]))
                    {
                        ...
                        hero.heroFall(levels[currentLevel]);
                    }
                    ...
                    //move left
                    else if(hero.getIsMovingLeft()&&!hero.isPlatformLeft(levels[currentLevel]))
                    {
                        hero.setX(hero.getX()-2);
                ...
                //         if (hero.getGun().getIsShooting()&&hero.getGun().getShootTimer()==0)
                //         {
                //             if(hero.getGun().getType()==1)
                //             machineGun.loop();
                //
                ...
                if(!hero.getGun().getIsShooting()||hero.getGun().getAmmo()==0)
                {
    ...
    public void keyPressed(KeyEvent e)
    {
        if(gameState == 0&&!isDead)
        {
            ...
            {
                machineGun = getAudioClip(getCodeBase(),"shootshoot.wav");
                shotGun = getAudioClip(getCodeBase(),"shoot.wav");
                sniperGun = getAudioClip(getCodeBase(),"sniper.WAV");
                flameGun = getAudioClip(getCodeBase(),"hothot.wav");
                background = getAudioClip(getCodeBase(),"soundtrack.wav");

                //background.loop();
                deathSound = getAudioClip(getCodeBase(),"death.wav");
                freezeGun = getAudioClip(getCodeBase(),"coldcold.wav");
                explosionSound = getAudioClip(getCodeBase(),"kaboom.wav");
                boxSound = getAudioClip(getCodeBase(),"powerup.wav");
                characterHitSound = getAudioClip(getCodeBase(),"ow!.wav");
                turretSound = getAudioClip(getCodeBase(),"shootshoot.wav");
                crouch = getAudioClip(getCodeBase(),"crouch.wav");
                gameState = 1;
                isFun=true;
            }
        }
        else if(gameState==1)
        {
            ...
            if(e.getKeyCode() == KeyEvent.VK_DOWN&& hero.getIsJumping()==false )
            {
       ...
       // platforms6.add(new Platform(900, 425, 15, 10));
        ...
        platforms11.add(new MysteryPlatform(0,350,30,30));
        platforms11.add (new MovingPlatform(100,405,50,10,0,2,60));
        platforms11.add (new MovingPlatform(150,300,50,10,2,0,65*(3/2)));
        platforms11.add (new MovingPlatform(400,180,50,10,0,-2,60));
        platforms11.add (new MovingPlatform(50,200,50,10,2,0,150));
        platforms11.add (new MovingPlatform(0,200,50,10,0,2,70));
        platforms11.add (new MovingPlatform(80,60,50,10,2,0,125*(3/2)));
        platforms11.add(new Platform(450,80,20,220));
        platforms11.add(new Platform(470,225,50,10));
        platforms11.add (new MovingPlatform(550,350,50,10,2,0,100));
        platforms11.add (new MovingPlatform(800,350,50,10,0,2,80*(3/2)));
